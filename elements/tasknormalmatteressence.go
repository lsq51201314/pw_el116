...
type TasknormalmatterEssence struct {
...
func (TasknormalmatterEssence) TableName() string {
	return "el_tasknormalmatteressence"
}

func (e *TasknormalmatterEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *TasknormalmatterEssence) SetData(data []byte) (err error) {
