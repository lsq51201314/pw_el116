...
type NpcEquipundestroyService struct {
...
func (NpcEquipundestroyService) TableName() string {
	return "el_npcequipundestroyservice"
}

func (e *NpcEquipundestroyService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcEquipundestroyService) SetData(data []byte) (err error) {
