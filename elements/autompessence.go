...
type AutompEssence struct {
	...
	TotalMp       int     `elements:"name:total_mp;type:int;size:4;text:未知;" gorm:"column:total_mp;type:integer;default:0;not null;" json:"total_mp"`
...
func (AutompEssence) TableName() string {
	return "el_autompessence"
}

func (e *AutompEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *AutompEssence) SetData(data []byte) (err error) {
