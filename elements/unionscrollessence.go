...
type UnionscrollEssence struct {
...
func (UnionscrollEssence) TableName() string {
	return "el_unionscrollessence"
}

func (e *UnionscrollEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *UnionscrollEssence) SetData(data []byte) (err error) {
