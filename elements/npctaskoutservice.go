...
func (NpcTaskOutService) TableName() string {
	return "el_npctaskoutservice"
}

func (e *NpcTaskOutService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcTaskOutService) SetData(data []byte) (err error) {
