...
type NpcEquipdestroyService struct {
...
func (NpcEquipdestroyService) TableName() string {
	return "el_npcequipdestroyservice"
}

func (e *NpcEquipdestroyService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcEquipdestroyService) SetData(data []byte) (err error) {
