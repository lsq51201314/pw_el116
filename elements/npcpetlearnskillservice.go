...
type NpcPetlearnskillService struct {
...
func (NpcPetlearnskillService) TableName() string {
	return "el_npcpetlearnskillservice"
}

func (e *NpcPetlearnskillService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcPetlearnskillService) SetData(data []byte) (err error) {
