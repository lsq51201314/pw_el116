...
func (TownscrollEssence) TableName() string {
	return "el_townscrollessence"
}

func (e *TownscrollEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *TownscrollEssence) SetData(data []byte) (err error) {
