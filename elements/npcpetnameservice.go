...
func (NpcPetnameService) TableName() string {
	return "el_npcpetnameservice"
}

func (e *NpcPetnameService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcPetnameService) SetData(data []byte) (err error) {
