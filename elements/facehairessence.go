...
type FaceHairEssence struct {
	ID               int    `elements:"name:id;type:int;size:4;text:未知;" gorm:"column:id;type:integer;autoIncrement:false;uniqueIndex;not null;" json:"id"`
	Name             string `elements:"name:name;type:unicode;size:64;text:未知;" gorm:"column:name;type:varchar(64);not null;" json:"name"`
	FileHairSkin     string `elements:"name:file_hair_skin;type:gbk;size:128;text:未知;" gorm:"column:file_hair_skin;type:varchar(128);not null;" json:"file_hair_skin"`
	FileHairModel    string `elements:"name:file_hair_model;type:gbk;size:128;text:未知;" gorm:"column:file_hair_model;type:varchar(128);not null;" json:"file_hair_model"`
...
func (FaceHairEssence) TableName() string {
	return "el_facehairessence"
}

func (e *FaceHairEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *FaceHairEssence) SetData(data []byte) (err error) {
