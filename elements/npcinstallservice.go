...
func (NpcInstallService) TableName() string {
	return "el_npcinstallservice"
}

func (e *NpcInstallService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcInstallService) SetData(data []byte) (err error) {
