...
type ArmorEssence struct {
	...
	MpEnhanceLow             int     `elements:"name:mp_enhance_low;type:int;size:4;text:未知;" gorm:"column:mp_enhance_low;type:integer;default:0;not null;" json:"mp_enhance_low"`
	MpEnhanceHigh            int     `elements:"name:mp_enhance_high;type:int;size:4;text:未知;" gorm:"column:mp_enhance_high;type:integer;default:0;not null;" json:"mp_enhance_high"`
	HpEnhanceLow             int     `elements:"name:hp_enhance_low;type:int;size:4;text:未知;" gorm:"column:hp_enhance_low;type:integer;default:0;not null;" json:"hp_enhance_low"`
	HpEnhanceHigh            int     `elements:"name:hp_enhance_high;type:int;size:4;text:未知;" gorm:"column:hp_enhance_high;type:integer;default:0;not null;" json:"hp_enhance_high"`
	...
	DropProbabilitySocket3   float32 `elements:"name:drop_probability_socket3;type:float;size:4;text:未知;" gorm:"column:drop_probability_socket3;type:float;default:0;not null;" json:"drop_probability_socket3"`
	DropProbabilitySocket4   float32 `elements:"name:drop_probability_socket4;type:float;size:4;text:未知;" gorm:"column:drop_probability_socket4;type:float;default:0;not null;" json:"drop_probability_socket4"`
	...
	MakeProbabilitySocket3   float32 `elements:"name:make_probability_socket3;type:float;size:4;text:未知;" gorm:"column:make_probability_socket3;type:float;default:0;not null;" json:"make_probability_socket3"`
	MakeProbabilitySocket4   float32 `elements:"name:make_probability_socket4;type:float;size:4;text:未知;" gorm:"column:make_probability_socket4;type:float;default:0;not null;" json:"make_probability_socket4"`
...
func (ArmorEssence) TableName() string {
	return "el_armoressence"
}

func (e *ArmorEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *ArmorEssence) SetData(data []byte) (err error) {
