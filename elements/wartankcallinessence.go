...
type WarTankcallinEssence struct {
...
func (WarTankcallinEssence) TableName() string {
	return "el_wartankcallinessence"
}

func (e *WarTankcallinEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *WarTankcallinEssence) SetData(data []byte) (err error) {
