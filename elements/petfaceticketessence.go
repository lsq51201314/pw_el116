...
type PetFaceticketEssence struct {
...
func (PetFaceticketEssence) TableName() string {
	return "el_petfaceticketessence"
}

func (e *PetFaceticketEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *PetFaceticketEssence) SetData(data []byte) (err error) {
