...
func (ElementEssence) TableName() string {
	return "el_elementessence"
}

func (e *ElementEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *ElementEssence) SetData(data []byte) (err error) {
