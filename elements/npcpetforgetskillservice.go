...
type NpcPetforgetskillService struct {
...
func (NpcPetforgetskillService) TableName() string {
	return "el_npcpetforgetskillservice"
}

func (e *NpcPetforgetskillService) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *NpcPetforgetskillService) SetData(data []byte) (err error) {
