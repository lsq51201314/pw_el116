...
type RevivescrollEssence struct {
...
func (RevivescrollEssence) TableName() string {
	return "el_revivescrollessence"
}

func (e *RevivescrollEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *RevivescrollEssence) SetData(data []byte) (err error) {
