...
func (DestroyingEssence) TableName() string {
	return "el_destroyingessence"
}

func (e *DestroyingEssence) GetSize() (size int, err error) {
	return structEx.GetSize(e)
}

func (e *DestroyingEssence) SetData(data []byte) (err error) {
